...
document.addEventListener('DOMContentLoaded', () => {
    const productDetails = document.getElementById('balsaTray-product-details');
    const urlParams = new URLSearchParams(window.location.search);
    const productId = urlParams.get('id');

    // Find the product with the matching ID
    const product = balsaTrayPrcts.find(p => p.id.toString() === productId);
    ...
    if (product) {
        ...
        <p class='product-cut'>Measures: <span class='light-font'>${product.measures}</span></p>
