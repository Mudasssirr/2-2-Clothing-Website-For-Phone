...
document.addEventListener('DOMContentLoaded', () => {
    const productDetails = document.getElementById('cushions-product-details');
    const urlParams = new URLSearchParams(window.location.search);
    const productId = urlParams.get('id');

    // Find the product with the matching ID
    const product = cushionPrcts.find(p => p.id.toString() === productId);
    ...
    if (product) {
        ...
        <p class='product-cut'>Dimension: <span class='light-font'>${product.dimensions}</span></p>
